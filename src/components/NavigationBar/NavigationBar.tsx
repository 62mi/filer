  ...
  return (
    <div className="flex items-center gap-1 h-10 px-2 bg-white border-b border-[#e5e5e5] shrink-0">
      ...
      <div className="flex-1 mx-1">
        {editing ? (
          <div className="flex items-center h-7 bg-white border border-[#0078d4] rounded overflow-hidden">
            <input
              ref={inputRef}
          ...
          <div
            className="flex items-center h-7 px-2 text-sm bg-[#f0f0f0] rounded cursor-text hover:bg-[#e8e8e8] overflow-hidden transition-colors duration-100 group"
      ...
      {/* Search bar */}
      <div className="flex items-center h-7 w-52 px-2 bg-[#f0f0f0] rounded text-sm focus-within:bg-white focus-within:border focus-within:border-[#0078d4] transition-all duration-150">
