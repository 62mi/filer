    ...
    >
      ...
      >
        ...
        <div className="flex items-center h-10 px-4 border-b border-[#e5e5e5] shrink-0">
          ...
          <span className="font-semibold text-sm text-[#1a1a1a] flex-1">AI設定</span>
          <button
        ...
        <div className="p-4 space-y-4 max-h-[70vh] overflow-auto">
          ...
          <div>
            ...
            <input
              ...
              placeholder={hasApiKey ? "••••••••（設定済み）" : "sk-ant-..."}
          ...
          <div className="flex items-center gap-2 text-xs">
            {hasApiKey ? (
              <span className="text-green-600 flex items-center gap-1">
                <Check className="w-3 h-3" /> APIキー設定済み
              </span>
            ) : (
              <span className="text-[#999]">APIキーが未設定です</span>
            )}
          </div>

          <p className="text-[10px] text-[#999]">
            APIキーは Anthropic Console (console.anthropic.com) で取得できます。
            キーはローカルに保存され、外部には送信されません。
          </p>
          ...
          <div className="border-t border-[#f0f0f0] pt-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-medium text-[#666]">月間予算</span>
            </div>
            ...
            {usageInfo && (
              <div className="bg-[#fafafa] rounded-lg p-3 space-y-2">
                <div className="text-xs font-medium text-[#666]">今月の使用量</div>
                <div className="flex items-center gap-4 text-[11px] text-[#999]">
                  <span>入力: {usageInfo.input_tokens.toLocaleString()} tok</span>
                  <span>出力: {usageInfo.output_tokens.toLocaleString()} tok</span>
